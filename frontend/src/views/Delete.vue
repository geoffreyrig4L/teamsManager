...
const teams = {
  ...
  barca: {
    name: "FC Barcelone",
    description: "La Macia et MESSIIIIIII",
    urlLogo: "barca.svg",
  },
  bayern: {
    name: "Bayern de Munich",
    description: "Les puissants en Allemagne",
    urlLogo: "bayern.svg",
  },
  lens: {
    name: "RC Lens",
  ...
  united: {
    ...
    description: "City mais en moins bien",
    urlLogo: "manchester_united.svg",
  },
  ol: {
    name: "Olympique Lyonnais",
    description: "Partir d'en bas et rester en bas",
    urlLogo: "ol.svg",
  },
  om: {
    name: "Olympique de Marseille",
    description: "Droit au but, Le vrai olympique, Aux armes",
    urlLogo: "om.svg",
  },
  psg: {
...
const selected = ref({ name: "", description: "" });
</script>
    ...
    >
      ...
      <div class="flex justify-center">
        <select
          ...
          v-model="selected"
        >
          <option disabled :value="{ name: '', description: '' }">
            Select a team
          </option>
      ...
      <div className="flex flex-col gap-6">
        <label className="form-control w-full max-w-md">
          <div className="label">
            <span className="label-text text-lg italic">Team name :</span>
          </div>
          <p>{{ selected?.name }}</p>
        </label>
        <label className="form-control w-full max-w-md">
          <div className="label">
            <span className="label-text text-lg italic"
